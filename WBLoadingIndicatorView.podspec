#
# Be sure to run `pod lib lint WBLoadingIndicatorView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of WBLoadingIndicatorView.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'WBLoadingIndicatorView' => ['WBLoadingIndicatorView/Assets/*.png']
  # }
